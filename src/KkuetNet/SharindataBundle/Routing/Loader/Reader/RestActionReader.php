...
namespace KkuetNet\SharindataBundle\Routing\Loader\Reader;
 ...
 */
class RestActionReader extends \FOS\RestBundle\Routing\Loader\Reader\RestActionReader
{
    ...
    private function getHttpMethodAndResourcesFromMethod(\ReflectionMethod $method, $resource)
    {
        ...
        if (0 === strpos($httpMethod, 'c')
            ...
            if (!empty($resource)) {
                $resource[count($resource)-1] = end($resource);
            }
        }
